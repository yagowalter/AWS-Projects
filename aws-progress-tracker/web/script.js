...
const kcs = [
    ...
    { title: "KC 212 - JAWS - KC - Computação (servidores)", deadline: "expirado" },
    { title: "KC 197 - CERT - KC - Computação em nuvem", deadline: "expirado" },
    { title: "KC 213 - JAWS - KC - Computação (dimensionamento e resolução de nomes)", deadline: "expirado" },
    { title: "KC 214 - JAWS - KC - Computação (contêineres)", deadline: "expirado" },
    { title: "KC 200 - CERT - KC - Compute", deadline: "expirado" },
    { title: "KC 198 - CERT - KC - Economia da nuvem", deadline: "expirado" },
    { title: "KC 204 - CERT - KC - Bancos de dados", deadline: "expirado" },
    { title: "KC 199 - CERT - KC - Infraestrutura global da AWS", deadline: "expirado" },
    { title: "KC 202 - CERT - KC - Amazon Virtual Private Cloud [VPC]", deadline: "expirado" },
    { title: "KC 207 - CERT - KC - Balanceamento - Dimensionamento - Monitoramento", deadline: "expirado" },
    { title: "KC 215 - JAWS - KC - Computação (bancos de dados)", deadline: "expirado" },
    { title: "KC 216 - Serviços de rede AWS", deadline: "expirado" },
    { title: "KC 217 - JAWS - KC - Armazenamento e arquivamento", deadline: "expirado" },
    { title: "KC 203 - CERT - KC - Armazenamento", deadline: "expirado" },
    { title: "KC 205 - CERT - KC - Cobrança e suporte", deadline: "09/02/2026" },
    { title: "KC 206 - CERT - KC - Arquitetura em nuvem", deadline: "09/02/2026" },
    { title: "KC 195 - CERT - KC - Preparação da Certificação do Cenário de Avaliação", deadline: "09/02/2026" },
    { title: "KC 196 - CERT - KC - Prática de estratégia de teste de cenário", deadline: "09/02/2026" },
...
const labs = [
    ...
    { title: "Lab 170 - Criar um site no S3", deadline: "expirado" },
    { title: "Lab 171 - Criando instâncias do Amazon EC2", deadline: "expirado" },
    { title: "Lab 174 - Dimensionar e balancear a carga da arquitetura", deadline: "expirado" },
    { title: "Lab 175 - Usar o Auto Scaling na AWS (Linux)", deadline: "expirado" },
    { title: "Lab 176 - Roteamento de failover do Route 53", deadline: "expirado" },
    { title: "Lab 178 - Trabalhar com o AWS Lambda", deadline: "expirado" },
    { title: "Lab 179 - Migrar para o Amazon RDS", deadline: "expirado" },
    { title: "Lab 180 - Configurar uma Amazon VPC", deadline: "expirado" },
    { title: "Lab 181 - Solucionar problemas de uma VPC", deadline: "expirado" },
    { title: "Lab 182 - Trabalhar com o Amazon EBS", deadline: "expirado" },
    { title: "Lab 185 - Trabalhar com o Amazon S3", deadline: "expirado" },
    { title: "Lab 186 - Monitorar a infraestrutura", deadline: "09/02/2026" },
    { title: "Lab 187 - Trabalhar com o AWS CloudTrail", deadline: "09/02/2026" },
    { title: "Lab 188 - Gerenciar recursos com marcação", deadline: "09/02/2026" },
    { title: "Lab 189 - Otimizar a utilização", deadline: "09/02/2026" },
    { title: "Lab 190 - Automatização de implantações com o AWS CloudFormation", deadline: "09/02/2026" },
    { title: "Lab 191 - Solucionar problemas de implantações do AWS CloudFormation", deadline: "09/02/2026" },
